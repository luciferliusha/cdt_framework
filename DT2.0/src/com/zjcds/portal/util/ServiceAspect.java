...
public final class ServiceAspect {
    ...
    private final Log log = LogFactory.getLog("com.zjcds.portal.service.impl");

    public void before(JoinPoint joinPoint) {
        String joinpoint = joinPoint.toString();
        String tempmsg = joinpoint.substring(joinpoint.indexOf("com.zjcds.portal.service"), joinpoint.length() - 1);
